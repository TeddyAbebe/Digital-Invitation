...
const goldIcon = L.divIcon({
  ...
  html: `<div style="
    ...
    background: linear-gradient(145deg, #f5f7fa, #d4af37);
...
export default function LocationMap() {
  ...
  useEffect(() => {
    ...
    L.marker([venueLocation.lat, venueLocation.lng], { icon: goldIcon })
      .addTo(map)
      .bindPopup(
        `<strong style="color:#b38b1a">${invitation.venue}</strong><br/><span style="opacity:0.85">${invitation.address}</span>`,
      );
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        <Reveal variant="scale" delay={150} duration={800}>
          <div className="overflow-hidden rounded-2xl bg-white/50 p-1 sm:p-2">
            <div
              ref={containerRef}
        ...
        >
          <a
            ...
            className="btn-gold inline-flex items-center gap-2 rounded-full px-6 py-2.5 font-[family-name:var(--font-sans)] text-sm text-[#ffffff]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-[#b38b1a]/25 px-5 py-2.5 font-[family-name:var(--font-sans)] text-sm text-[#1a1a1a]/70 transition hover:border-[#b38b1a]/50 hover:text-[#b38b1a]"
          >
